...
//   // - remove calendar
//   const removeCalnedar = async (id) => {
//     try {
//       const res = await fetch("/api/calnedar", {
//         method: "DELETE",
//         headers: { "Content-Type": "application/json" },
...
//       if(!res.ok) {
//         setMsg("Error in remove calendar : ", data.error || "Failed to remove element");
//         return;
//       }
//       setMsg("Calendar remove");
//       fetchCalendars();
//     } catch (error) {
//       console.log("Error in remove calendar : ", error);
//       setMsg("Error in remove calnedar");
//     }
//   }
...
export default function CalendarPage() {
  ...
  try {
    ...
    if (!res.ok) {
      setMsg(`Request failed with status ${res.status}`);
      return;
    }
